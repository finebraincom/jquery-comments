    ...
    var Comments = {
        ...
        getDefaultOptions: function () {
            return {
                ...
                textareaPlaceholderText: 'Add to the discussion...',
                newestText: 'Newest',
                oldestText: 'Oldest',
                popularText: 'Popular',
        ...
        updateToggleAllButton: function (parentEl) {
            ...
            if (this.options.maxRepliesVisible === 0) {
                hiddenReplies = childComments;
            } else {
                hiddenReplies = childComments.slice(0, -this.options.maxRepliesVisible);
            }
            ...
            if (!textarea.find('.reply-to.tag').length) {
                ...
                if (commentId) {
                    ...
                    if (parentComments.length > 1) {
                        parentId = parentComments.last().data('id');
                        textarea.attr('data-parent', parentId);
                    }

                    // Case: new comment
                } else {
                    parentId = textarea.parents('li.comment').last().data('id');
                    textarea.attr('data-parent', parentId);
                }
            }
        ...
        createCommentingFieldElement: function (parentId, existingCommentId, isMain) {
            ...
            this.profilePictureWrapper = profilePicture;
            ...
            var closeButton = $('<i class="material-icons">close</i>');
            closeButton.addClass('close inline-button');
            ...
            if (existingCommentId) {
                ...
                saveButtonText = this.options.textFormatter(this.options.sendText);
        ...
        createCommentElement: function (commentModel) {
            ...
            if (commentModel.parent == null) {
                // var commentsDivider = $('<div/>', {
                //     'class': 'comments-divider'
                // });
                // commentEl.prepend(commentsDivider);
        ...
        createCommentWrapperElement: function (commentModel) {
            ...
            // });
            var upvoteIcon = $('<i class="material-icons">thumb_up</i>');
            ...
            // });
            var downvoteIcon = $('<i class="material-icons">thumb_down</i>');
            ...
            // if (toggleContent) wrapper.append(toggleContent);
            wrapper.append(actions);
            var commentInfoWrapper = $('<div/>', {
                'class': 'comment-info-wrapper'
            });
            commentInfoWrapper.append(profilePicture).append(name).append(time);
            commentWrapper.append(commentInfoWrapper).append(wrapper);
        ...
        adjustTextareaHeight: function (textarea, focus) {
            ...
            var isAreaScrollable, maxRowsUsed;
            do {
                setRows(rowCount);
                rowCount++;
