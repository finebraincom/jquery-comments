...
var $,I=U.frequencyBinCount,E=new Uint8Array(I),L=R.width,F=R.height,A=L/I*6,B=0,M=!0
...
u.append(K)}var V=e("<div/>",{class:"actions"}),Z=e("<div/>",{class:"mdl-button action reply",type:"button",text:this.options.textFormatter(this.options.replyText)}),J=e('<i class="material-icons">thumb_up</i>')
...
if(this.options.enableReplying&&V.append(Z),t.createdByCurrentUser||this.options.currentUserIsAdmin)if(f&&this.isAllowedToDelete(t.id)){var X=e("<div/>",{class:"mdl-button action delete enabled",text:this.options.textFormatter(this.options.deleteText)})
V.append(X)}else if(!f&&this.options.enableEditing){var ee=e("<div/>",{class:"mdl-button action edit",text:this.options.textFormatter(this.options.editText)})
