...
var P=t.fileName,S=e("<div/>",{class:"attachment-wrapper"}),j=e("<i/>",{class:O})
this.options.fileIconURL.length&&(j.css("background-image",'url("'+this.options.fileIconURL+'")'),j.addClass("image"))
var N=e("<span/>",{text:P})
S.append(j).append(N),l.prepend(S)}u.html(l)}else if(t.content.length>300){var z=t.content.substr(300,t.content.length-1)
if(z.length>50&&z.indexOf("")>-1){var q=this.getFormattedCommentContent(t.content.substr(0,300+z.indexOf(" ")))+'<span class="moreellipses">...</span><span class="morecontent"><span class="morelink readmore-'+t.id+'">Show more >></span></span>'
u.html(q)}else u.html(this.getFormattedCommentContent(t.content))
var W=e(".comments-wrapper")
W.off("click","span.readmore-"+t.id),W.on("click","span.readmore-"+t.id,_.bind(function(n){var i
return e(n.currentTarget).hasClass("less")?(i=this.getFormattedCommentContent(t.content.substr(0,300+z.indexOf(" ")))+'<span class="moreellipses">...</span><span class="morecontent"><span class="morelink readmore-'+t.id+'">Show more >></span></span>',u.html(i)):(i=this.getFormattedCommentContent(t.content)+'<span class="less morelink readmore-'+t.id+'">Show less <<</span>',u.html(i)),!1},this))}else u.html(this.getFormattedCommentContent(t.content))
if(t.modified&&t.modified!=t.created){var K=this.options.timeFormatter(t.modified),V=e("<time/>",{class:"edited",text:this.options.textFormatter(this.options.editedText)+" "+K,"data-original":t.modified})
u.append(V)}var Z=e("<div/>",{class:"actions"}),J=e("<div/>",{class:"mdl-button action reply",type:"button",text:this.options.textFormatter(this.options.replyText)}),Q=e('<i class="material-icons">thumb_up</i>')
