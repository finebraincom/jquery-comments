...
return n.append(a),null==t.parent&&n.append(i),n},createCommentWrapperElement:function(t){function n(){if(!M){requestAnimationFrame(n),B=0,U.getByteFrequencyData(E),D.fillStyle="#FFF",D.fillRect(0,0,F,L)
for(var e=0;e<I;e++)$=3*E[e],D.fillStyle="#2196F1",D.fillRect(B,L-$,A-3,$),B+=A+1}}var i=e("<div/>",{class:"comment-wrapper"}),a=this.createProfilePictureElement(t.profilePictureURL),o=e("<div/>",{class:"time",text:this.options.timeFormatter(t.created),"data-original":t.created}),r=t.createdByCurrentUser?this.options.textFormatter(this.options.youText):t.fullname,s=e("<div/>",{class:"name"})
...
2==C.length&&(g=C[1],v=C[0])}var l=e("<div/>",{class:"attachment"})
...
var $,I=U.frequencyBinCount,E=new Uint8Array(I),F=R.width,L=R.height,A=F/I*6,B=0,M=!0
y.bind("play",function(){M=!1,n()}),y.bind("pause ended",function(){setTimeout(function(){M=!0},1e3)})}else{var H=["archive","audio","code","excel","image","movie","pdf","photo","picture","powerpoint","sound","video","word","zip"],O="fa fa-file-o"
